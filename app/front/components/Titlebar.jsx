...
module.exports = React.createClass({
  ...
  render () {
    ...
    if (this.state.altDown) {
      maxOrFullIcon = (
        hx`<svg className='titlebar__maximize-svg' x='0px' y='0px' viewBox='0 0 7.9 7.9'>
          <polygon points='7.9,4.5 7.9,3.4 4.5,3.4 4.5,0 3.4,0 3.4,3.4 0,3.4 0,4.5 3.4,4.5 3.4,7.9 4.5,7.9 4.5,4.5'/>
        </svg>`
      )
    } else {
      maxOrFullIcon = (
        hx`<svg className='titlebar__fullscreen-svg' x='0px' y='0px' viewBox='0 0 6 5.9'>
          <path d='M5.4,0h-4L6,4.5V0.6C5.7,0.6,5.3,0.3,5.4,0z'/>
          <path d='M0.6,5.9h4L0,1.4l0,3.9C0.3,5.3,0.6,5.6,0.6,5.9z'/>
        </svg>`
      )
    }

    return (
      hx`<div className='titlebar'>
